...
def teamInfoDisplay(frame):
    ...
    leaderPic = Image.open('Images/Gitesh-Profile-Pic.jpeg')
    leaderPic = leaderPic.resize((150, 150))
    leaderPic = ImageTk.PhotoImage(leaderPic)
    leaderPicLabel = tkinter.Label(frame, image=leaderPic)
    leaderPicLabel.image = leaderPic
    leaderPicLabel.grid(row=1, column=1, sticky='N')

    # Leader Name
    leaderName = tkinter.Label(frame, text="Gitesh Jetly", font=('Arial', 15))
    leaderName.grid(column=1, row=2, sticky='N')

    # Leader Institute Name
    leaderInstituteName = tkinter.Label(frame, text='Dr. Akhilesh Das Gupta Institute\nof\nTechnology & Management')
    leaderInstituteName.grid(column=1, row=3, sticky='N')

    # Leader Passing Batch
    leaderPassingBatchLabel = tkinter.Label(frame, text='2023', font=('Arial', 15))
    leaderPassingBatchLabel.grid(column=1, row=4, sticky='n')
    ...
    memberOnePic = Image.open('Images/Piyush-Profile-Pic.jpeg')
    memberOnePic = memberOnePic.resize((150, 150))
    memberOnePic = ImageTk.PhotoImage(memberOnePic)
    memberOnePicLabel = tkinter.Label(frame, image=memberOnePic)
    memberOnePicLabel.image = memberOnePic
    memberOnePicLabel.grid(row=1, column=2, sticky='n')

    # Member-1 Name
    memberOneName = tkinter.Label(frame, text='Piyush Bharadwaj', font=('Arial', 15))
    memberOneName.grid(row=2, column=2, sticky='n')

    # Member-1 Institute Name
    memberOneInstituteName = tkinter.Label(frame, text='Dr. Akhilesh Das Gupta Institute\nof\nTechnology & Management')
    memberOneInstituteName.grid(column=2, row=3, sticky='N')

    # Member-1 Passing Batch
    memberOnePassingBatchLabel = tkinter.Label(frame, text='2023', font=('Arial', 15))
    memberOnePassingBatchLabel.grid(column=2, row=4, sticky='n')
    ...
    memberTwoPic = Image.open('Images/Sanskriti-Profile_Pic.jpeg')
    memberTwoPic = memberTwoPic.resize((150, 150))
    memberTwoPic = ImageTk.PhotoImage(memberTwoPic)
    memberTwoPicLabel = tkinter.Label(frame, image=memberTwoPic)
    memberTwoPicLabel.image = memberTwoPic
    memberTwoPicLabel.grid(row=1, column=3, sticky='n')

    # Member-2 Name
    memberTwoName = tkinter.Label(frame, text=' Sanskriti Anand', font=('Arial', 15))
    memberTwoName.grid(row=2, column=3, sticky='n')

    # Member-2 Institute Name
    memberTwoInstituteName = tkinter.Label(frame, text='Dr. Akhilesh Das Gupta Institute\nof\nTechnology & Management')
    memberTwoInstituteName.grid(column=3, row=3, sticky='N')

    # Member-2 Passing Batch
    memberTwoPassingBatch = tkinter.Label(frame, text='2023', font=('Arial', 15))
    memberTwoPassingBatch.grid(column=3, row=4)
...
def gui():
    ...
    teamNameLabel = tkinter.Label(topMenuFrame, text="Tech-Junkies", font=('Arial', 20))
    teamNameLabel.grid(columnspan=3, row=0, sticky="N", padx=5)

    # Image of team
    flipkartPic = Image.open('Images/Flipkart-GRiD-4.0.png')
